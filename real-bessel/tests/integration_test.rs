...
/// These are ths same cases as amos-bessel-rs, reused here for consistency, but not
/// imported from amos-bessel-rs directly to avoid the cross-crate dependencies.
#[template]
#[rstest]
#[case(4.0, 2.1, 0.0)]
#[case(5.0, 2.0001, 0.0)]
...
#[case(172302836.50840142, 1.2494954195932068e-254, -981_457_506.317_919_3)] // 40
#[case(645.0, -736006017.5, 0.0)]
#[case(1253.5, 0.0, 2102.4)]
