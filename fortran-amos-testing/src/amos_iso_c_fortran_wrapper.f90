...
subroutine zbesj_wrap(zr, zi, order, kode, N, cyr, cyi, nz, ierr) bind(C, name="zbesj_wrap_testing")
...
subroutine zbesy_wrap(zr, zi, order, kode, N, cyr, cyi, nz, cwrkr, cwrki, ierr) bind(C, name="zbesy_wrap_testing")
...
subroutine zbesi_wrap(zr, zi, order, kode, N, cyr, cyi, nz, ierr) bind(C, name="zbesi_wrap_testing")
...
subroutine zbesk_wrap(zr, zi, order, kode, N, cyr, cyi, nz, ierr) bind(C, name="zbesk_wrap_testing")
...
subroutine zbesh_wrap(zr, zi, order, kode, M, N, cyr, cyi, nz, ierr) bind(C, name="zbesh_wrap_testing")
...
subroutine zairy_wrap(zr, zi, id, kode, air, aii, nz, ierr) bind(C, name="zairy_wrap_testing")
...
subroutine zbiry_wrap(zr, zi, id, kode, bir, bii, ierr) bind(C, name="zbiry_wrap_testing")
