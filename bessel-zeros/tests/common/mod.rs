...
pub fn get_records(input: &str) -> Result<Vec<Vec<String>>, Box<dyn Error>> {
...
pub fn parse_zeros_python(input: &str) -> Vec<Vec<f64>> {
    get_records(input)
        .unwrap()
        .into_iter()
...
pub fn parse_zeros_wa(input: &str) -> Vec<Vec<f64>> {
