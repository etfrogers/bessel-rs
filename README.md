...
- **[amos-bessel-rs](./amos-bessel-rs)**: Idiomatic Rust translation of Amos' Bessel function algorithms.
- **[real-bessel](./real-bessel)**: Faster, real-only Bessel function implementations.
- **[bessel-zeros](./bessel-zeros)**: Tools for finding zeros of Bessel functions.
